...
<div class="container">
 <div class="d-flex flex-row">
    ...
    <form class="" action="editarEvento.php" method="post">
    <label for="">INGRESA EL NOMBRE DEL EVENTO A EDITAR:</label>
    <input type="text" name="nombre" value="">
    <label for="">Ingresa los datos nuevos</label>
    <br>
    <label for="">Nombre</label>
    <input type="text" name="nombreNuevo" value="">
       <br>
  ...
  <label for="">Ubicacion</label>
    ...
    <button type="submit" name="crearEvento">Modificar evento</button>
    </form>
