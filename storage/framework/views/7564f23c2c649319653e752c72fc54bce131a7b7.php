    ...
    <nav class="navbar navbar-dark bg-dark">
      <div class="container">
        ...
        <div class="login-container">
          <ul>
            <li style="color:white">Bienvenido <?php echo e(Auth::user()->name); ?> </li>
            <li class="pr-2 pl-2"><a href="/perfil" class="btn btn-success" >Perfil</a></li>
...
<?php /**PATH C:\Users\Bruno\JugaYa_\JugaYa\resources\views/inicio.blade.php ENDPATH**/ ?>